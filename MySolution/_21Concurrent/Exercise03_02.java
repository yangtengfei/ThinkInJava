 ...
 * @todo:TODO
 */
public class Exercise03_02 implements Runnable{
private String startMsg, endMsg;
	
	public Exercise03_02() {}
	public Exercise03_02(String start, String end) {
		startMsg = start;
		endMsg = end;
	}
	...
	public static void main(String[] args) {
		...
		ExecutorService exe = Executors.newFixedThreadPool(3);// 一次性线程分配
		for (int i = 0; i < 3; i++) {
			exe.execute(new Exercise03_02(startMsg, endMsg));
		}
		exe.shutdown();
	}
}
