 ...
 * @todo:TODO
 */
public class Exercise05 implements Callable<String>,Generator<Integer>{
	private int n;
	private int count = 0;
	public Integer next() { return fib(count++); }//实现Generator接口
	public Exercise05(){}
	public Exercise05(int n){//含有构造参数的构造器
		this.n = n;
		System.out.println("Exercise05 " + n);
	}
	@Override
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 10; i++) result.add(exes.submit(new Exercise05(i)));
